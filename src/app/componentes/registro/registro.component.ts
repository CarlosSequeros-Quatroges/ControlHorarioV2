...
export class RegistroComponent {
  ...
  public modelChanged(ev: Event, formName: any) {
    if (formName == 'horaEntrada') {
      ...
      var inicio =
        String(this.datepipe.transform(date1, 'dd/MM/yyyy')) +
        ' ' +
  ...
  registraInicio() {
    var inicio: string = String(
      this.datepipe.transform(new Date(), 'dd/MM/yyyy HH:mm:00'),
    );
  ...
  public reinicia() {
    ...
    this.registro.modifica_inicio = 'N';
    this.registro.modifica_final = 'N';
  }
}
